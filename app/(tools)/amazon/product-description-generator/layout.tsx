...
const howToJsonLd = generateHowToJsonLd({
  ...
  steps: [
    ...
    },
    {
      ...
      "description": "Click generate to get your AI-powered product description generator. Copy and use it on amazon."
    }
  ],
  language: "en",
});
...
const faqJsonLd = generateFaqJsonLd([
    {
      "question": "Is the amazon Product Description Generator free?",
...
const speakableJsonLd = generateSpeakableJsonLd({
  pageName: "Amazon Product Description Generator",
  url: "https://kivitools.com/amazon/product-description-generator",
});
