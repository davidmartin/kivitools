...
const howToJsonLd = generateHowToJsonLd({
  toolName: "ElevenLabs Video Voiceover Script Generator",
  description: "Generate professional voiceover scripts optimized for ElevenLabs AI voice synthesis.",
  steps: [
    {
    ...
    },
    {
      ...
      "description": "Click generate to get your AI-powered video voiceover script. Copy and use it on elevenlabs."
    }
  ],
  language: "en",
});
...
const faqJsonLd = generateFaqJsonLd([
    {
      "question": "Is the elevenlabs Video Voiceover Script free?",
...
const speakableJsonLd = generateSpeakableJsonLd({
  pageName: "ElevenLabs Video Voiceover Script Generator",
  url: "https://kivitools.com/elevenlabs/video-voiceover-script",
});
