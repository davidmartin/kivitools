...
export default function EtsyToolsPage() {
    ...
    const tools = [
        {
            name: t("etsyProductTitle.title"),
            description: t("etsyProductTitle.description"),
            href: "/etsy/product-title-generator",
            icon: "🏷️",
        },
        {
            name: t("etsyProductDescription.title"),
            description: t("etsyProductDescription.description"),
            href: "/etsy/product-description-generator",
            icon: "📝",
        },
        {
            name: t("etsyShopAnnouncement.title"),
            description: t("etsyShopAnnouncement.description"),
    ...
    return (
        <div className="min-h-screen bg-background relative overflow-hidden">
            ...
            <div className="absolute inset-0 overflow-hidden pointer-events-none">
                <div className="absolute top-[-10%] left-[-10%] w-[50vw] h-[50vw] bg-orange-600/20 rounded-full blur-[100px] animate-float-slow opacity-40" />
            ...
            <div className="relative max-w-7xl mx-auto px-4 py-20">
                ...
                <div className="text-center mb-20 relative z-10">
                    <div className="inline-flex items-center justify-center mb-8 animate-fade-in">
                        <div className="relative">
                            <div className="absolute inset-0 bg-linear-to-r from-orange-600 to-orange-500 blur-xl opacity-50 animate-pulse-glow rounded-full" />
                            <PlatformLogo platform="etsy" size="xl" className="relative z-10" />
                        </div>
                    </div>

                    <h1 className="text-5xl md:text-7xl font-black text-foreground mb-6 animate-slide-up tracking-tight">
                        {t("nav.etsy")} <span className="text-transparent bg-clip-text bg-linear-to-r from-orange-600 to-orange-400">{t("nav.tools")}</span>
                    </h1>

                    <p className="text-xl md:text-2xl text-muted max-w-2xl mx-auto animate-slide-up leading-relaxed" style={{ animationDelay: "0.1s" }}>
                        {t("etsy.page.description")}
                    </p>
                </div>
                            ...
                            <Card className="glass-card h-full border-white/10 bg-white/5 hover:bg-white/10 transition-all duration-500 group-hover:-translate-y-2">
                                <Card.Header className="pt-8 px-8">
                                    <div className="flex items-start justify-between w-full mb-4">
                                        <div className="w-12 h-12 rounded-2xl bg-linear-to-br from-orange-600/20 to-orange-500/20 flex items-center justify-center text-3xl group-hover:scale-110 transition-transform duration-500 border border-white/10">
                                            {tool.icon}
                                        </div>
                                    ...
                                    <Card.Title className="text-2xl font-bold text-foreground group-hover:text-transparent group-hover:bg-clip-text group-hover:bg-linear-to-r group-hover:from-orange-600 group-hover:to-orange-400 transition-all duration-300">
                                        {tool.name}
                                    </Card.Title>
                                </Card.Header>
                ...
                <div className="mt-20 bg-surface/50 backdrop-blur-sm rounded-3xl p-8 md:p-12 border border-white/10">
                    ...
                    <p className="text-muted text-lg leading-relaxed">
                        {t("etsy.info.description")}
                    </p>
                </div>

                <CustomToolsList platform="etsy" />
            </div>
        </div>
    );
}
