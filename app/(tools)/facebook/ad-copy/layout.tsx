...
const howToJsonLd = generateHowToJsonLd({
  ...
  steps: [
    ...
    },
    {
      ...
      "description": "Click generate to get your AI-powered ad copy generator. Copy and use it on facebook."
    }
  ],
  language: "en",
});
...
const faqJsonLd = generateFaqJsonLd([
    {
      "question": "Is the facebook Ad Copy Generator free?",
...
const speakableJsonLd = generateSpeakableJsonLd({
  pageName: "Facebook Ad Copy Generator",
  url: "https://kivitools.com/facebook/ad-copy",
});
