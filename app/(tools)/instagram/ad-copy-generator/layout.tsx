...
const howToJsonLd = generateHowToJsonLd({
  toolName: "Instagram Ad Copy Generator",
  description: "Generate high-converting Instagram ad copy with AI. Boost your ad performance.",
  steps: [
    {
    ...
    },
    {
      ...
      "description": "Click generate to get your AI-powered ad copy generator. Copy and use it on instagram."
    }
  ],
  language: "en",
});
...
const faqJsonLd = generateFaqJsonLd([
    {
      "question": "Is the instagram Ad Copy Generator free?",
...
const speakableJsonLd = generateSpeakableJsonLd({
  pageName: "Instagram Ad Copy Generator",
  url: "https://kivitools.com/instagram/ad-copy-generator",
});
