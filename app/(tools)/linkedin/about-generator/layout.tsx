...
const howToJsonLd = generateHowToJsonLd({
  toolName: "LinkedIn About Generator",
  description: "Generate compelling LinkedIn about sections with AI. Tell your professional story.",
  steps: [
    {
    ...
    },
    {
      ...
      "description": "Click generate to get your AI-powered about section generator. Copy and use it on linkedin."
    }
  ],
  language: "en",
});
...
const faqJsonLd = generateFaqJsonLd([
    {
      "question": "Is the linkedin About Section Generator free?",
...
const speakableJsonLd = generateSpeakableJsonLd({
  pageName: "LinkedIn About Generator",
  url: "https://kivitools.com/linkedin/about-generator",
});
