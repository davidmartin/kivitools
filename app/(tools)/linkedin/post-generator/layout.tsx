...
const howToJsonLd = generateHowToJsonLd({
  toolName: "LinkedIn Post Generator",
  description: "Generate engaging LinkedIn posts with AI. Build your professional brand.",
  steps: [
    {
    ...
    },
    {
      ...
      "description": "Click generate to get your AI-powered post generator. Copy and use it on linkedin."
    }
  ],
  language: "en",
});
...
const speakableJsonLd = generateSpeakableJsonLd({
  pageName: "LinkedIn Post Generator",
  url: "https://kivitools.com/linkedin/post-generator",
});
