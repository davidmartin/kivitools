...
export default function MediumToolsPage() {
    ...
    const tools = [
        {
            name: t("mediumArticleTitle.title"),
            description: t("mediumArticleTitle.description"),
            href: "/medium/article-title-generator",
            icon: "📰",
        },
        {
            name: t("mediumArticleIntro.title"),
            description: t("mediumArticleIntro.description"),
            href: "/medium/article-intro-generator",
            icon: "✍️",
        },
        {
            name: t("mediumBio.title"),
            description: t("mediumBio.description"),
    ...
    return (
        <div className="min-h-screen bg-background relative overflow-hidden">
            ...
            <div className="absolute inset-0 overflow-hidden pointer-events-none">
                <div className="absolute top-[-10%] left-[-10%] w-[50vw] h-[50vw] bg-gray-600/20 rounded-full blur-[100px] animate-float-slow opacity-40" />
                <div className="absolute bottom-[-10%] right-[-10%] w-[60vw] h-[60vw] bg-gray-500/20 rounded-full blur-[120px] animate-float-slow opacity-40" style={{ animationDelay: "-5s" }} />
            </div>
                ...
                <div className="text-center mb-20 relative z-10">
                    <div className="inline-flex items-center justify-center mb-8 animate-fade-in">
                        <div className="relative">
                            <div className="absolute inset-0 bg-linear-to-r from-gray-600 to-gray-500 blur-xl opacity-50 animate-pulse-glow rounded-full" />
                    ...
                    <h1 className="text-5xl md:text-7xl font-black text-foreground mb-6 animate-slide-up tracking-tight">
                        {t("nav.medium")} <span className="text-transparent bg-clip-text bg-linear-to-r from-gray-600 to-gray-400">{t("nav.tools")}</span>
                    </h1>
                            ...
                            <Card className="glass-card h-full border-white/10 bg-white/5 hover:bg-white/10 transition-all duration-500 group-hover:-translate-y-2">
                                <Card.Header className="pt-8 px-8">
                                    <div className="flex items-start justify-between w-full mb-4">
                                        <div className="w-12 h-12 rounded-2xl bg-linear-to-br from-gray-600/20 to-gray-500/20 flex items-center justify-center text-3xl group-hover:scale-110 transition-transform duration-500 border border-white/10">
                                            {tool.icon}
                                        </div>
                                    ...
                                    <Card.Title className="text-2xl font-bold text-foreground group-hover:text-transparent group-hover:bg-clip-text group-hover:bg-linear-to-r group-hover:from-gray-600 group-hover:to-gray-400 transition-all duration-300">
                                        {tool.name}
                                    </Card.Title>
                                </Card.Header>
