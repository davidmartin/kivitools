...
export default function PinterestToolsPage() {
  const { t } = useLanguage();

  const tools = [
    {
      name: t("pinterestPinDescription.title"),
      description: t("pinterestPinDescription.description"),
      href: "/pinterest/pin-description",
      icon: "📌",
    },
    {
      name: t("pinterestBoardName.title"),
      description: t("pinterestBoardName.description"),
      href: "/pinterest/board-name",
      icon: "📋",
    },
    {
      name: t("pinterestProfileBio.title"),
      description: t("pinterestProfileBio.description"),
  ...
  return (
    <div className="min-h-screen bg-background relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute bottom-[-10%] right-[-10%] w-[60vw] h-[60vw] bg-red-400/20 rounded-full blur-[120px] animate-float-slow opacity-40" style={{ animationDelay: "-5s" }} />
      </div>
      ...
      <div className="relative max-w-7xl mx-auto px-4 py-20">
        ...
        <div className="text-center mb-20 relative z-10">
          <div className="inline-flex items-center justify-center mb-8 animate-fade-in">
            <div className="relative">
              <div className="absolute inset-0 bg-red-500 blur-xl opacity-50 animate-pulse-glow rounded-full" />
              <PlatformLogo platform="pinterest" size="xl" className="relative z-10" />
            </div>
          </div>

          <h1 className="text-5xl md:text-7xl font-black text-foreground mb-6 animate-slide-up tracking-tight">
            {t("nav.pinterest")} <span className="text-transparent bg-clip-text bg-linear-to-r from-red-500 to-red-600">{t("nav.tools")}</span>
          </h1>

          <p className="text-xl md:text-2xl text-muted max-w-2xl mx-auto animate-slide-up leading-relaxed" style={{ animationDelay: "0.1s" }}>
            {t("pinterest.page.description")}
          </p>
        </div>
              ...
              <Card className="glass-card h-full border-white/10 bg-white/5 hover:bg-white/10 transition-all duration-500 group-hover:-translate-y-2">
                <Card.Header className="pt-8 px-8">
                  <div className="flex items-start justify-between w-full mb-4">
                    <div className="w-12 h-12 rounded-2xl bg-linear-to-br from-red-500/20 to-red-600/20 flex items-center justify-center text-3xl group-hover:scale-110 transition-transform duration-500 border border-white/10">
                      {tool.icon}
                    </div>
                  ...
                  <Card.Title className="text-2xl font-bold text-foreground group-hover:text-transparent group-hover:bg-clip-text group-hover:bg-linear-to-r group-hover:from-red-500 group-hover:to-red-600 transition-all duration-300">
                    {tool.name}
                  </Card.Title>
                </Card.Header>
        ...
        <div className="mt-20 bg-surface rounded-2xl p-8 shadow-lg animate-slide-up" style={{ animationDelay: "0.3s" }}>
          <h2 className="text-3xl font-bold text-foreground mb-4">
            {t("pinterest.info.title")}
          </h2>
          <p className="text-muted text-lg leading-relaxed">
            {t("pinterest.info.description")}
          </p>
        </div>

        <CustomToolsList platform="pinterest" />
      </div>
    </div>
  );
}
