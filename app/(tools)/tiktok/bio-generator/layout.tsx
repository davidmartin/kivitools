...
const howToJsonLd = generateHowToJsonLd({
  ...
  steps: [
    ...
    },
    {
      ...
      "description": "Click generate to get your AI-powered bio generator. Copy and use it on tiktok."
    }
  ],
  language: "en",
});
...
const faqJsonLd = generateFaqJsonLd([
    {
      "question": "Is the tiktok Bio Generator free?",
...
const speakableJsonLd = generateSpeakableJsonLd({
  pageName: "TikTok Bio Generator",
  url: "https://kivitools.com/tiktok/bio-generator",
});
