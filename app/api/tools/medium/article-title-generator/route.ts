...
export async function POST(request: NextRequest) {
    try {
        ...
        const titles = await generateMediumArticleTitles({
            topic: topic.trim(),
        ...
        console.error("Medium title generation error:", error);
        return NextResponse.json(
...
export async function GET() {
    return NextResponse.json({ status: "ok", service: "Medium Article Title Generator" });
}
